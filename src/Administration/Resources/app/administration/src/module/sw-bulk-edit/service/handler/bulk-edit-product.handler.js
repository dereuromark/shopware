...
class BulkEditProductHandler extends BulkEditBaseHandler {
     ...
     * computed per product instead of sharing a single value across all selected products (e.g. a product with
     * 2 images gets position 3 while a product with 3 images gets position 4).
     */
