 ...
 * @internal
 */
#[AsMessageHandler(handles: WebhookSuspensionEscalatorTask::class)]
#[Package('framework')]
final class WebhookSuspensionEscalatorTaskHandler extends ScheduledTaskHandler
{
    /**
    ...
    {
        $this->lifecycle?->escalateSuspendedToDisabled();
    }
}
